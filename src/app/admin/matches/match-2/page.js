// src/app/admin/matches/match-2/page.js
// src/app/admin/matches/match-2/page.js
"use client";
...
export default function Match2Page() {
  ...
  async function handleGenerateSwiss() {
    ...
    try {
      ...
      await generateSwissMatch(prevMatchIds, 2);
      await fetchMatches();
      setMessage("✅ Swiss Match 2 generated!");
    } catch (err) {
  ...
  async function handleClearMatch() {
    if (!confirm("Clear Swiss Match 2?")) return;
    setLoading(true);
    try {
      ...
      setMatches([]);
      setRounds({});
      setMessage("✅ Swiss Match 2 cleared");
    } catch (err) {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 p-8 bg-gray-50 rounded-xl shadow-lg">
      ...
      <div className="flex gap-4 mb-6">
        ...
        >
          {loading ? "Generating..." : "Generate Match 2 (Swiss)"}
        </button>
